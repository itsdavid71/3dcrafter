<footer>
    <div class="container">
        <div class="row footer_blocks">
            ...
            <div class="footer_block col-md-3">
                ...
                <a href="#" class="footer_link">3D-печать</a>
                <a href="#" class="footer_link">3D-моделирование</a>
                <a href="#" class="footer_link">Стоимость</a>
                <a href="#" class="footer_link">Обучение</a>
                <a href="#" class="footer_link">Ремонт</a>
            </div>
            <div class="footer_block col-md-3">
                <p class="footer_title">КОМПАНИЯ</p>
                <a href="#" class="footer_link">О нас</a>
                <a href="#" class="footer_link">Технологии</a>
                <a href="#" class="footer_link">Новости</a>
                <p class="footer_title last_title">FAQ</p>
                <a href="#" class="footer_link">Мин. заказ</a>
    ...
    <script src="scripts-shop/owl.carousel.min.js"></script>
    <script src="scripts-shop/jquery.magnific-popup.min.js"></script>
